...
export default function AdminNotificationsPage() {
  ...
  const getNotificationUrl = (notification: Notification): string | null => {
    ...
    if (notification.related_entity_type === 'product' && notification.related_entity_id) {
      return `/admin/products/${notification.related_entity_id}`
    }

    if (notification.related_entity_type === 'support_ticket' && notification.related_entity_id) {
      return `/admin/support/${notification.related_entity_id}`
    }

    if (notification.related_entity_type === 'inventory' && notification.related_entity_id) {
